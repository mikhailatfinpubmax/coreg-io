<form name="iterable_optin" action="https://whatsonfinance.com/templp/co-reg/interactive_offers.html" method="GET" class="d-flex flex-column h-100 justify-content-around p-4 p-xl-5">
...
<script>
    document.querySelector('form').addEventListener('submit', function(event) {
        ...
        var url2 = 'https://whatsonfinance.com/templp/co-reg/interactive_offers.html?email=' + encodeURIComponent(emailValue);
